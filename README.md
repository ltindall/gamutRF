...
Ensure you have airstack 0.5.5rc2 or later .deb installed.
...
$ gamutrf-sigfinder --freq-start=300e6 --freq-end=6e9 --promport=9009 --fftgraph fft.png --port 9005 --buff_path /tmp/
```
